...
>
> 그럼에도 Attention Head가 공간적 분리를 학습하여, 동일 학습 데이터에서 표준 CNN 대비 **+1.8%p Subset Accuracy** 향상을 달성했습니다. 향후 bbox 라벨을 추가하면 더 큰 성능 향상이 기대됩니다.
...
- **FNR**: False Negative Rate → 놓친 양성 비율
...
**Eval4 (Detection) - 중첩 테스트**: 가장 깔끔한 분리. 단, `corner_rect`(sep=0.746)과 `nail`(sep=0.621)은 상대적으로 약함
...
|---|:---:|:---:|:---:|:---:|
| `row_line` | 0.627 (35%) | 0.932 (6%) | 0.934 (5%) | **0.956 (4%)** |
| `col_line` | 0.619 (38%) | 0.896 (10%) | 0.899 (8%) | **0.947 (4%)** |
| `corner_rect` | 0.445 (55%) | **0.865 (7%)** | 0.842 (9%) | 0.746 (14%) |
| `nail` | 0.477 (51%) | **0.911 (6%)** | 0.900 (6%) | 0.621 (9%) |
| `edge` | 0.442 (59%) | 0.893 (8%) | 0.835 (12%) | **0.912 (6%)** |
| `block` | 0.735 (28%) | 0.963 (3%) | 0.911 (7%) | **0.979 (2%)** |
| `scatter` | 0.926 (4%) | **0.998 (0%)** | **0.998 (0%)** | **1.000 (0%)** |
